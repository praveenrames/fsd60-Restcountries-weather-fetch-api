  ...
  var parent = document.querySelector(".row");
   ...
   for (let i of out) {
     try {
       ...
       // codes
       var country_codes = document.createElement("p");
       country_codes.innerText = "Contry code : " + i.cca3;
       data_cont.append(country_codes);
...
async function clicking(e) {
  ...
  // console.log(out1);
  var result = document.querySelector("body div.heading");
  result.innerHTML = "";
